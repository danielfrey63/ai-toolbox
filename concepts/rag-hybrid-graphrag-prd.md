...
**Status:** Konsolidiert, bereit für M1 · **Stand:** 2026-07-12 12:05 CEST · **Owner:** Daniel Frey · **Referenz-Analyse:** [graphify-analyse.md](graphify-analyse.md)
...
3. **M3 — Härtung:** Inkrementelle Re-Indexierung (Manifest, Stat-Fast-Path, Replace-on-Re-Extract), Trigger-Schicht (post-commit-Hook, opt-in Watcher), Eval-Suite (Fragenkatalog mit erwarteten Quellen), weitere Loader (PDF, Code).
