---
description: Watch a video (URL or local path). Downloads with yt-dlp, extracts frames with ffmpeg (auto-chunked for long videos), transcribes via captions / Whisper / optional speaker diarization, and produces a three-file report (protocol + transcript + analysis) plus a clickable Summary in chat.
